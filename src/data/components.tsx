...
import { WesternCategories } from '~/components/WesternCategories'
...
const WESTERN_CATEGORIES_CODE = `const WESTERN_CATEGORIES = [
  {
    id: 'dresses',
    label: 'DRESSES',
    ...
    <section className="w-full bg-[#ebebeb] px-4 py-3 md:px-8 md:py-6">
      <div className="mx-auto grid w-full max-w-[1700px] grid-cols-2 gap-3 md:grid-cols-4 md:gap-6">
        {WESTERN_CATEGORIES.map((category) => (
          <article key={category.id} className="group relative aspect-[4/7] overflow-hidden rounded-sm bg-neutral-200">
            <img src={category.image} alt={category.label.replace('\n', ' ')} loading="lazy" className="h-full w-full object-cover transition duration-500 group-hover:scale-105" />
...
export const COMPONENTS: ComponentRecord[] = [
  ...
  {
    uuid: '90ef60f6-5c9b-4578-a7a9-15be47f89f78',
    id: 'western-categories',
    name: 'Western Categories',
    premium: false,
    image:
      'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=900&q=80',
    component: () => <WesternCategories />,
    code: WESTERN_CATEGORIES_CODE,
  },
  {
